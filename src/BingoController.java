...
public class BingoController {
   ...
   //implement code here
    ...
    public void setSize() {
        ...
        System.out.println("The bingo card size is set to " + getCurrentRowSize() +  "rows X " + getCurrentColumnSize() + "Columns");
    ...
    */
    public void listCards() {
        for(int i=0 ;i<cards.size();i++){
            System.out.printf("Card %d numbers: \n",i);
    ...
    public void setSeparator() {
        ...
        System.out.printf("Separator is '%s'\n",Defaults.getNumberSeparator());
        /* TODO
    ...
    public void markNumbers(int number) {
        for(int i=0;i<cards.size();i++){
            System.out.printf("Checking card %d for %d\n",i,number);
        ...
        do {
            switch (Toolkit.getInputForMessage(getMenu(mainMenuItems))) {
                ...
                case OPTION_SIZE:
                    ...
                    break;
                default:
                    System.out.println("invalid entry. Please choose from the list");
                //insert code here
            }
        } while (!finished);
    }
